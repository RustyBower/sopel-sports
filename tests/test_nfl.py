...
def test_get_token(mockbot):
    with requests_mock.Mocker() as mock:
        mock.post(
            ...
            json={
                "accessToken": "",
                "expiresIn": 0,
            },
        )
        assert (
