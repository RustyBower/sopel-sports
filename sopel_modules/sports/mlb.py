...
def parse_games(date):
    if date:
        r = requests.get('https://statsapi.mlb.com/api/v1/schedule?sportId=1&date={}'.format(date))
    else:
    ...
    for date in r.json()['dates']:
        ...
        for game in date['games']:
            ...
            if game['status']['abstractGameState'] == 'Preview':
                ...
                # Away Team Win
                if int(game['teams']['away']['score']) > int(game['teams']['home']['score']):
                    reply.append('{} {} {} {} Final'.format(
